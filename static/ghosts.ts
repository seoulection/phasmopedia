...
export const GHOSTS: Ghost[] = [
  ...
  },
  {
    ...
    isFast: false,
    sanity: 70,
    strengths: ['Can initiate hunts more often', 'Can hunt at max sanity'],
  ...
  },
  {
    ...
    weaknesses: ['Moves very slowly when near its victim'],
  },
  {
    name: 'Goryo',
    evidences: [
  ...
  },
  {
    ...
    isFast: true,
    sanity: 50,
    strengths: ['Moves faster in lower temperatures'],
    weaknesses: [
  ...
  },
  {
    ...
    isFast: true,
    sanity: 50,
    strengths: ['Travels faster if a player is in line of sight'],
    weaknesses: [
  ...
  {
    name: 'Mare',
    evidences: [Evidence.GhostOrb, Evidence.GhostWriting, Evidence.SpiritBox],
    guaranteedEvidence: null,
    isFast: false,
    sanity: 60,
  ...
  },
  {
    ...
    isFast: false,
    sanity: 50,
    strengths: ['Produces quieter sounds during a hunt'],
    weaknesses: [
  ...
  },
  {
    ...
    isFast: false,
    sanity: 50,
    strengths: ['May leave fingerprints that disappear faster'],
    weaknesses: [
  ...
  },
  {
    ...
    isFast: false,
    sanity: 60,
    strengths: ['Can attack when a flame is extinguished'],
    weaknesses: ['The presence of flames reduces its ability to attack'],
  },
  {
    name: 'Phantom',
    evidences: [
  ...
  {
    name: 'Yokai',
    evidences: [Evidence.DOTSProjector, Evidence.GhostOrb, Evidence.SpiritBox],
    guaranteedEvidence: null,
    isFast: false,
    sanity: 80,
    strengths: ['Talking near it will increase chance of attack'],
